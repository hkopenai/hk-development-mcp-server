...
class TestMCPClientSimulation(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.server_process = subprocess.Popen(
            [sys.executable, "-m", "hkopenai.hk_development_mcp_server", "--sse"],
    ...
    def test_get_new_building_plans_processed_tool(self):
        logger.debug("Testing 'get_new_building_plans_processed' tool...")
        asyncio.run(self._call_tool_and_assert("get_new_building_plans_processed", {"start_year": 2020, "end_year": 2021}))
