...
class TestApp(unittest.TestCase):
    ...
    def test_create_mcp_server(self, mock_tool_new_building_plan_processed, mock_fastmcp):
        # Setup mocks
        mock_server = Mock()
        ...
        decorated_funcs['get_new_building_plans_processed'](start_year=2020, end_year=2021)
        mock_tool_new_building_plan_processed.get_new_building_plans_processed.assert_called_once_with(2020, 2021)
