"""
Module for testing the new building plan processed tool functionality.

This module contains unit tests for fetching and filtering new building plan processed data.
"""
...
class TestNewBuildingPlanProcessed(unittest.TestCase):
    ...
    def test_get_new_building_plans_processed(self):
        ...
        # Mock the CSV data
        mock_csv_data = [
            {"Year": "2019", "Month": "1", "First Submission & Major Revision": "100", "Re-submission": "50", "Total": "150"},
            {"Year": "2019", "Month": "2", "First Submission & Major Revision": "110", "Re-submission": "55", "Total": "165"},
            {"Year": "2020", "Month": "1", "First Submission & Major Revision": "120", "Re-submission": "60", "Total": "180"},
            {"Year": "2021", "Month": "1", "First Submission & Major Revision": "130", "Re-submission": "65", "Total": "195"},
        ]
        ...
        with patch(
            ...
            self.assertEqual(result[0]["Total"], "150")

            # Test empty result for non-matching years
            result = _get_new_building_plans_processed(2022, 2023)
